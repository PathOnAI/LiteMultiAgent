...
tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Perform a search either using local file or web search and return the results.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "The search query to be sent to an agent to search local file or do web search."
                    }
                },
                "required": [
                    "query"
