...
## 📰 News
* [2024-10-01] Integrate LiteWebAgent: [https://github.com/PathOnAI/LiteWebAgent](https://github.com/PathOnAI/LiteWebAgent) into LiteMultiAgent repo to enable hierarchical multi-agent framework with web browsing capacities.
